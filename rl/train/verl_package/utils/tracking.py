...
class _TensorboardAdapter:
    def __init__(self, project_name, experiment_name):
        ...
        # [Modified] Support TENSORBOARD_LOG_PATH env var
        tb_root = os.environ.get("TENSORBOARD_LOG_PATH", "tensorboard_log")
        default_dir = os.path.join(tb_root, project_name, experiment_name)
    ...
    def log_generations_to_tensorboard(self, samples, step):
        ...
        if not hasattr(self, "writer"):
            ...
            if self.project_name and self.experiment_name:
                default_dir = os.path.join(tb_root, self.project_name, self.experiment_name)
            else:
                default_dir = tb_root
